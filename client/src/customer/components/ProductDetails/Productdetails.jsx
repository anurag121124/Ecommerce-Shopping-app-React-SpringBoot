    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          {/* Product info */}
          <div className="lg:col-span-1 max-auto max-2-2xl px-4 pb-60 sm:px-60 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h2 className="text-lg lg:text-[1rem] font-semibold text-gray-900 ">
                NoFilter
              </h2>
